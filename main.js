...
let projects = [
  {
    image: 'textures/growmate.png',
    url: 'https://growzone.daffadev.my.id/',
  },
  {
    image: 'textures/ligazone3.png',
    url: 'https://ligazone.ospk47.my.id',
  },
  {
    image: 'textures/ospk.png',
    url: 'https://ospk47.my.id',
  },
  {
    image: 'textures/ligazone2.png',
    url: 'https://ligazone109.wordpress.com',
  },
];
let aboutCameraPos = {
  x: 0.12,
...
function loadIntroText() {
  ...
  loader.load('fonts/unione.json', function (font) {
    ...
    const titleGeo = new TextGeometry('DAFFA ADITYA PRATAMA', {
      font: font,
      size: 0.08,
      height: 0.01,
    });
